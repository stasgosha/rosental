...
<?php include('header.php'); ?>
	<div class="page-content">
				...
				<div class="try-for-free-section-inner">
					...
					<div class="tfr-phone">
						...
						<div class="tfr-phone-text">
							...
							<p class="ros-body-1 margin-no">Хотите попробовать <span>абсолютно</span> бесплатно? <br>Подробности по телефону</p>
						</div>
					</div>
		...
		<div class="section white-section why-we-section">
			<div class="container">
				<div class="row">
					<div class="col-md-12 col-lg-6 margin-bottom-big lg-margin-bottom-no">
						<div class="ros-typography lg-padding-right-medium">
							<h2 class="text-center text-sm-left">Зачем автоматизировать управляющую компанию?</h2>
